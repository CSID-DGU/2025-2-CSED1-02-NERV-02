...
from app.schemas.enums import ModerationAction
...
class PolicyManager:
    ...
    def decide_action(
        ...
        if user_security_level == 1:   # 관찰
            ...
            final_action = ModerationAction.PERMANENT_DELETE
